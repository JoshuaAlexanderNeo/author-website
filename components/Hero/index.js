...
const Hero = () => {
  return (
    <>
      <div className='container mx-auto h-screen flex flex-col justify-end md:flex-row md:justify-between'>
        <div className='flex flex-col w-full justify-center items-start pb-12 px-12'>
